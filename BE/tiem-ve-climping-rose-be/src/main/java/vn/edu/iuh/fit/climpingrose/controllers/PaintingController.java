...
public class PaintingController {
        ...
        public ApiResponse<PageResponse<PaintingResponse>> getAllPaintings(
                ...
                PageResponse<PaintingResponse> result = paintingService.getAllPaintings(page, size, categoryIds, sizes,
                                isActive, keyword, sort);
        ...
        @DeleteMapping
        public ApiResponse<Void> deletePainting(@RequestParam String paintingId) {
